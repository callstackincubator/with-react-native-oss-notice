class WithReactNativeLegalDetailViewController: UIViewController {
    ...
    private var metadata: WithReactNativeLegalLicenseMetadata
    
    init(metadata: WithReactNativeLegalLicenseMetadata) {
